...
export const Default: Story = {
  render: (args) => ({
    ...
    template: `<usli-input [formControl]="ctrl" type="text" placeholder="Enter text" />`,
  }),
};
  ...
  render: (args) => ({
    ...
    template: `
      <usli-form-field label="Email">
        <usli-input [formControl]="ctrl" type="email" placeholder="your@email.com" />
      </usli-form-field>
    `,
  }),
};
...
export const WithValidation: Story = {
  render: (args) => ({
    props: { ...args, ctrl: new FormControl('', [Validators.required, Validators.email]) },
    template: `
      <usli-form-field label="Email">
        <usli-input [formControl]="ctrl" type="email" placeholder="your@email.com" />
      </usli-form-field>
  ...
  render: (args) => ({
    ...
    template: `
      <usli-form-field label="Password">
        <usli-input [formControl]="ctrl" type="password" placeholder="••••••••" />
      </usli-form-field>
    `,
  }),
};
